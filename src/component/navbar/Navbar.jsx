...
import { Entertainment,Shopping,Personal,Professional,rigmenu1,rigmenu2 } from "./Data";
import { RigSubmenu } from "./submenu";

// import Circlemenuchange from "./menuclick"
...
const Navbar = () => {
  ...
  const swit = false;
  const [switbtn,setswitbtn]=useState(swit);

  const downbtnt = false;
  const [downbtn,setdownbtn]=useState(downbtnt);

  const downmenuchng=()=>{         
    var logoutbar = document.querySelector('.logoutmain');
    if(downbtn===false)
    {
      ...
      logoutbar.style.display ="grid";
        setdownbtn(false);
    }
  }
  const Circlemenuchange=()=>{         
    var managebar = document.querySelector('.circlemenu');
    if(switbtn===false)
    {
  ...
  return (
    <>
      <Container fluid className="navbarmain">
        <Row>
          <Col xs={6} md={3} className="firstportionnav">

            <svg viewBox="0 0 36 36" className="fbcolor" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4" fill="url(#jsc_s_17)" height="40" width="40"><defs><linearGradient x1="50%" x2="50%" y1="97.0782153%" y2="0%" id="jsc_s_17"><stop offset="0%" stop-color="#0062E0"></stop><stop offset="100%" stop-color="#19AFFF"></stop></linearGradient></defs><path d="M15 35.8C6.5 34.3 0 26.9 0 18 0 8.1 8.1 0 18 0s18 8.1 18 18c0 8.9-6.5 16.3-15 17.8l-1-.8h-4l-1 .8z"></path><path class="p361ku9c" d="M25 23l.8-5H21v-3.5c0-1.4.5-2.5 2.7-2.5H26V7.4c-1.3-.2-2.7-.4-4-.4-4.1 0-7 2.5-7 7v4h-4.5v5H15v12.7c1 .2 2 .3 3 .3s2-.1 3-.3V23h4z"></path></svg>
            <input type="text" placeholder="Search Facebook" className="searchboxwid1" />

          </Col>
          <Col xs={6} md={6} className="adjust_centre_menu">
            <NavLink activeClassName="menuactive" className="menunav" to="/home">
              <span className="Homemenu menumain">
                <svg viewBox="0 0 28 28" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 aaxa7vy3" height="28" width="28"><path d="M25.825 12.29C25.824 12.289 25.823 12.288 25.821 12.286L15.027 2.937C14.752 2.675 14.392 2.527 13.989 2.521 13.608 2.527 13.248 2.675 13.001 2.912L2.175 12.29C1.756 12.658 1.629 13.245 1.868 13.759 2.079 14.215 2.567 14.479 3.069 14.479L5 14.479 5 23.729C5 24.695 5.784 25.479 6.75 25.479L11 25.479C11.552 25.479 12 25.031 12 24.479L12 18.309C12 18.126 12.148 17.979 12.33 17.979L15.67 17.979C15.852 17.979 16 18.126 16 18.309L16 24.479C16 25.031 16.448 25.479 17 25.479L21.25 25.479C22.217 25.479 23 24.695 23 23.729L23 14.479 24.931 14.479C25.433 14.479 25.921 14.215 26.132 13.759 26.371 13.245 26.244 12.658 25.825 12.29"></path></svg>
              </span>
            </NavLink>

            <NavLink activeClassName="menuactive" className="menunav" to="/watch">
              <span className="Watchmenu  menumain">
            ...
            <NavLink activeClassName="menuactive" className="menunav" to="/marketplace">
              <span className="Marketplacemenu menumain">
            ...
            <NavLink activeClassName="menuactive" className="menunav" to="/group">
              <span className="Groupmenu menumain">
            ...
            <NavLink activeClassName="menuactive" className="menunav" to="/gaming">
              <span className="Gamingmenu menumain">
          ...
          <Col xs={6} md={3} className="right_sidetmenu">
            <Link to="/profile" className="profilemenu">
              <img src={Prof} alt="" srcset="" className="imgresmenu" />
              <span className="usernamepro">Rishi</span>
            </Link>

            <span className="mainmenucircle" onClick={Circlemenuchange}>
              <svg viewBox="0 0 44 44" fill="white" width="1em" height="1em" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry jnigpg78 odw8uiq3"><circle cx="7" cy="7" r="6"></circle><circle cx="22" cy="7" r="6"></circle><circle cx="37" cy="7" r="6"></circle><circle cx="7" cy="22" r="6"></circle><circle cx="22" cy="22" r="6"></circle><circle cx="37" cy="22" r="6"></circle><circle cx="7" cy="37" r="6"></circle><circle cx="22" cy="37" r="6"></circle><circle cx="37" cy="37" r="6"></circle></svg>
            </span>

            <span className="mainmenucircle">
              <svg viewBox="0 0 28 28" alt="" fill="white" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry" height="20" width="20"><path d="M14 2.042c6.76 0 12 4.952 12 11.64S20.76 25.322 14 25.322a13.091 13.091 0 0 1-3.474-.461.956 .956 0 0 0-.641.047L7.5 25.959a.961.961 0 0 1-1.348-.849l-.065-2.134a.957.957 0 0 0-.322-.684A11.389 11.389 0 0 1 2 13.682C2 6.994 7.24 2.042 14 2.042ZM6.794 17.086a.57.57 0 0 0 .827.758l3.786-2.874a.722.722 0 0 1 .868 0l2.8 2.1a1.8 1.8 0 0 0 2.6-.481l3.525-5.592a.57.57 0 0 0-.827-.758l-3.786 2.874a.722.722 0 0 1-.868 0l-2.8-2.1a1.8 1.8 0 0 0-2.6.481Z"></path></svg>
            </span>
            <Container className="circlemenu">
              <Row>
                <Col className="Menuhead">Menu</Col>
              </Row>

              <Row className="Menufloatport">
                <Col xs={8} className="Menufloatfirst">
                  <Col>
                    <input type="text" placeholder="Search Facebook" className="searchboxwid" />
                  </Col>
                  <Col className="menusubh">
                    Social
                  </Col>
              ...
              Professional
                ...
                <Col xs={3} className="MenufloatSecond">
                  
                <h5>Create</h5>
                
                  {rigmenu1.map((data, index)=>{
                    return<RigSubmenu  
                    // design={data.bgcolor} 
                    navimg={data.imgg}
                    head={data.heading}
                  ...
                  <Col className="borderbottom2">
                  </Col>
                  {rigmenu2.map((data, index)=>{
                    return<RigSubmenu  
                    // design={data.bgcolor} 
                    navimg={data.imgg}
                    head={data.heading}
            ...
            <span className="mainmenucircle">
              <svg viewBox="0 0 28 28" alt="" fill="white" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry" height="20" width="20"><path d="M7.847 23.488C9.207 23.488 11.443 23.363 14.467 22.806 13.944 24.228 12.581 25.247 10.98 25.247 9.649 25.247 8.483 24.542 7.825 23.488L7.847 23.488ZM24.923 15.73C25.17 17.002 24.278 18.127 22.27 19.076 21.17 19.595 18.724 20.583 14.684 21.369 11.568 21.974 9.285 22.113 7.848 22.113 7.421 22.113 7.068 22.101 6.79 22.085 4.574 21.958 3.324 21.248 3.077 19.976 2.702 18.049 3.295 17.305 4.278 16.073L4.537 15.748C5.2 14.907 5.459 14.081 5.035 11.902 4.086 7.022 6.284 3.687 11.064 2.753 15.846 1.83 19.134 4.096 20.083 8.977 20.506 11.156 21.056 11.824 21.986 12.355L21.986 12.356 22.348 12.561C23.72 13.335 24.548 13.802 24.923 15.73Z"></path></svg>
            </span>

            <span className="mainmenucircle" onClick={downmenuchng}>
              <svg viewBox="0 0 20 20" width="1em" fill="white" height="1em" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry jnigpg78 odw8uiq3"><path d="M10 14a1 1 0 0 1-.755-.349L5.329 9.182a1.367 1.367 0 0 1-.205-1.46A1.184 1.184 0 0 1 6.2 7h7.6a1.18 1.18 0 0 1 1.074.721 1.357 1.357 0 0 1-.2 1.457l-3.918 4.473A1 1 0 0 1 10 14z"></path></svg>
            </span>
            <Logoutmenu/>
